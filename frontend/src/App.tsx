			...
			<div className="dashboard-container">
						...
						<ul>
							...
							<li>
								<Link to="/salesCalls" className="menu-link">
									<Phone className="icon" /> Sales Calls
									Dashboard
								</Link>
							</li>
							<li>
								<Link
									to="/salesCalls/add"
									className="menu-link">
									<PlusCircle className="icon" /> Add Sales
									Call
								</Link>
							</li>
							<li>
								<Link to="/rates" className="menu-link">
									<BarChart className="icon" /> Rates
									Dashboard
								</Link>
							</li>
							<li>
				...
				<main className="main-content">
					<Routes>
						...
						<Route
							path="/salesCalls"
							element={<SalesCallsDashboard />}
						/>
						<Route
							path="/salesCalls/add"
							element={<AddSalesCall />}
						/>
