export default () => ({
  ...
  apiJwt: {
    ...
    refreshTokenSecret: process.env.API_REFRESH_TOKEN_SECRET || "api_refresh_token_secret",
  ...
  token: {
    forgotPwdExpireTimeOut: Number(process.env.FORGOT_PWD_TOKEN_EXPIRE) || 3600, // In Seconds
